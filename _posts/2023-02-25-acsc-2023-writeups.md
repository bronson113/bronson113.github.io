...
$$\begin{align}
 0 &\equiv 1 +  k*1 \phi(n) \pmod{e_1} \ 
0 &\equiv 1 +  k_2 \phi(n) \pmod{e_2} \ 
 \vdots & \
0 &\equiv 1 +  k*{63} \phi(n) \pmod{e_{63}} \ 
 \end{align}$$

 And a little bit of rearrange later

 $$\begin{align}
\phi(n) &\equiv -k*1^{-1} \pmod{e_1} \ 
\phi(n) &\equiv -k_2^{-1} \pmod{e_2} \ 
 \vdots & \
 \phi(n) &\equiv -k*{63}^{-1} \pmod{e_{63}} \ 
 \end{align}$$
...
$$\begin{align} k  \begin{bmatrix}  s*{1} \  s*{2} \ 0 \ 1 \ 0 \end{bmatrix}
				 +x \begin{bmatrix}  r*{1} \  r*{2} \  0 \  0 \  1 \  \end{bmatrix}
...
$$\begin{align} k  \begin{bmatrix}  s*{1} \  s*{2} \ 1 \ 0 \end{bmatrix}
				 +x \begin{bmatrix}  r*{1} \  r*{2} \  0 \  1 \  \end{bmatrix}
