(function() {
  ...
  window.Lazyload.js("https://code.jquery.com/jquery-3.7.0.min.js", function() {
    var $tags = $('.js-tags');
    var $articleTags = $tags.find('button');
    var $tagShowAll = $tags.find('.tag-btn--all');
    ...
    function buttonFocus(target) {
      if (target) {
        ...
        $lastFocusButton && !$lastFocusButton.is(target) && $lastFocusButton.removeClass('btn-info');
